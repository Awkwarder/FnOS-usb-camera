...
#define FFMPEG_CONFIGURATION "--prefix=output/cpu --enable-gpl --enable-nonfree --enable-libx264 --enable-libx265 --enable-libv4l2 --enable-libpulse --enable-shared --enable-static --enable-libmfx --enable-vaapi --enable-libdrm --disable-stripping --enable-postproc --extra-cflags=-fPIC"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2024
#define FFMPEG_DATADIR "output/cpu/share/ffmpeg"
#define AVCONV_DATADIR "output/cpu/share/ffmpeg"
